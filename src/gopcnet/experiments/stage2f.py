...
unmodified (`gopcnet.experiments.stage2b.Stage2bConfig`,
...
`gopcnet.experiments.stage2b`, rather than as just a new config, for
...
from gopcnet.experiments.stage2b import (
    MOTIF_COMPONENTS,
    Stage2bConfig,
    _condition_seed,
    _score,
...
def run_stage2f(config: Stage2bConfig, output_dir: Path) -> pd.DataFrame:
    ...
    from gopcnet.experiments.stage2f_reporting import write_stage2f_report
