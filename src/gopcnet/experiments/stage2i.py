...
bookend-reuse pattern (gopcnet.experiments.stage1i) exactly.
"""
...
from gopcnet.experiments.stage2d import MOTIF_COMPONENTS, OVERLAP_PAIRS, Stage2dConfig, _score
from gopcnet.experiments.stage2h import NOISE_COUNT, P, _sample_network
...
def run_stage2i(config: Stage2iConfig, bookend_raw_evidence_path: Path, output_dir: Path) -> pd.DataFrame:
    ...
    from gopcnet.experiments.stage2i_reporting import write_stage2i_report
