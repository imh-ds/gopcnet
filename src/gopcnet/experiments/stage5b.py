...
Reuses Stage 5a's own DGP samplers (`gopcnet.experiments.stage4l`,
`gopcnet.experiments.stage2d`), MINT/EBICglasso fitting helpers
(`gopcnet.experiments.stage5a._mint_adjacency`, `._graph_metrics`,
...
from gopcnet.experiments.stage5a import _graph_metrics, _mint_adjacency, _true_adjacency
...
def run_stage5b(
    ...
    if not write_report:
        return raw
    from gopcnet.experiments.stage5b_reporting import write_stage5b_report
