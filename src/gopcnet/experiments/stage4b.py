...
Reuses Stage 1k's hub DGP and ground truth (`gopcnet.experiments.
stage1k.TRUE_EDGES`, `INDIRECT_EDGES`, `gopcnet.simulation.sample_hub`)
and Stage 1L's overlap DGP and ground truth (`gopcnet.experiments.
stage1l.TRUE_EDGES`, `INDIRECT_EDGES`, `gopcnet.simulation.
sample_overlapping_triangles`) unmodified, and Stage 4a's sequential
engine (`gopcnet.pipeline.sequential_screen_and_prune_detailed`)
...
from gopcnet.experiments.stage1k import CHILDREN as HUB_CHILDREN
from gopcnet.experiments.stage1k import INDIRECT_EDGES as HUB_INDIRECT_EDGES
from gopcnet.experiments.stage1k import TRUE_EDGES as HUB_TRUE_EDGES
from gopcnet.experiments.stage1l import INDIRECT_EDGES as OVERLAP_INDIRECT_EDGES
from gopcnet.experiments.stage1l import TRUE_EDGES as OVERLAP_TRUE_EDGES
from gopcnet.pipeline import sequential_screen_and_prune_detailed
from gopcnet.simulation import sample_hub, sample_overlapping_triangles
