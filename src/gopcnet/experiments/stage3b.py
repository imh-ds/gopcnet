...
pipeline-plus-bootstrap runner (`gopcnet.experiments.stage3._run_one_replicate`,
...
columns -- it is applied in `gopcnet.experiments.stage3b_reporting`, not
...
from gopcnet.experiments.stage2d import CHAIN_INDIRECT, FORK_INDIRECT, NOISE_COUNT, OVERLAP_INDIRECT, P, TRUE_DIRECT_EDGES
from gopcnet.experiments.stage3 import _run_one_replicate
from gopcnet.simulation import sample_chain, sample_measured_fork, sample_overlapping_triangles
...
def run_stage3b(config: Stage3bConfig, output_dir: Path) -> pd.DataFrame:
    ...
    from gopcnet.experiments.stage3b_reporting import write_stage3b_report
