...
unmodified (`gopcnet.experiments.stage2c.Stage2cConfig`,
...
from gopcnet.experiments.stage2c import (
    MOTIF_COMPONENTS,
    Stage2cConfig,
    _condition_seed,
    _score,
...
def run_stage2g(config: Stage2cConfig, output_dir: Path) -> pd.DataFrame:
    ...
    from gopcnet.experiments.stage2g_reporting import write_stage2g_report
