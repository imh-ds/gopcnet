...
Re-runs Stage 3's exact primary-DGP procedure (gopcnet.bootstrap via
gopcnet.experiments.stage3._run_one_replicate, reused rather than
...
from gopcnet.experiments.stage2c import INDIRECT_EDGES, NOISE_COUNT, P, TRUE_DIRECT_EDGES
from gopcnet.experiments.stage3 import _run_one_replicate
from gopcnet.simulation import sample_chain, sample_hub, sample_measured_fork
...
def run_stage3c(config: Stage3cConfig, output_dir: Path) -> pd.DataFrame:
    ...
    from gopcnet.experiments.stage3c_reporting import write_stage3c_report
