...
unmodified (`gopcnet.experiments.stage1b.Stage1bConfig`,
...
itself (`gopcnet.pipeline.sequential_screen_and_prune` in place of
`gopcnet.dpi.prune_conditional_independence`). This module exists as its
...
from gopcnet.experiments.stage1b import Stage1bConfig, _condition_seed, load_stage1b_config
from gopcnet.metrics import score_motif
