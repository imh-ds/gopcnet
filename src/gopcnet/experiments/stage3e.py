...
(`gopcnet.experiments.stage3b.Stage3bConfig`, `load_stage3b_config`,
...
from gopcnet.experiments.stage2h import P, _sample_network
from gopcnet.experiments.stage3 import _run_one_replicate
from gopcnet.experiments.stage3b import (
    _BOOTSTRAP_STREAM,
    _DATA_STREAM,
    Stage3bConfig,
    _category,
