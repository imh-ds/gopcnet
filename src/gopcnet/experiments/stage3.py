...
- **primary (gated)**: Stage 2b's disjoint chain/fork/triangle network
  (`gopcnet.simulation.sample_screening_network`), already PROCEED at
...
from gopcnet.experiments.stage2b import INDIRECT_EDGES as PRIMARY_INDIRECT_EDGES
from gopcnet.experiments.stage2b import TRUE_DIRECT_EDGES as PRIMARY_TRUE_DIRECT_EDGES
from gopcnet.experiments.stage2d import CHAIN_INDIRECT as SECONDARY_CHAIN_INDIRECT
from gopcnet.experiments.stage2d import FORK_INDIRECT as SECONDARY_FORK_INDIRECT
from gopcnet.experiments.stage2d import NOISE_COUNT as SECONDARY_NOISE_COUNT
from gopcnet.experiments.stage2d import OVERLAP_INDIRECT as SECONDARY_OVERLAP_INDIRECT
from gopcnet.experiments.stage2d import P as SECONDARY_P
from gopcnet.experiments.stage2d import TRUE_DIRECT_EDGES as SECONDARY_TRUE_DIRECT_EDGES
...
from gopcnet.simulation import (
    sample_chain,
...
def run_stage3(config: Stage3Config, output_dir: Path) -> pd.DataFrame:
    ...
    from gopcnet.experiments.stage3_reporting import write_stage3_report
