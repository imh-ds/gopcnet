...
(`gopcnet.experiments.stage5b`'s DGP registry and noise mechanism,
`gopcnet.experiments.stage5c`'s `alpha(p)` screening-alpha
...
from gopcnet.experiments.stage5b import _DGP_REGISTRY, _sample_with_extra_noise
...
def run_stage5h(
    ...
    if not write_report:
        return raw
    from gopcnet.experiments.stage5h_reporting import write_stage5h_report
