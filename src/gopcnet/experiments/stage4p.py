...
Runs both engines (conservative: `gopcnet.pipeline.
compose_screen_then_prune`; sequential: `gopcnet.pipeline.
...
`gopcnet.experiments.stage2d`; hub-based, `gopcnet.experiments.stage4l`),
...
(`gopcnet.experiments.stage1j_fit`), not overlap's own specialized one
...
from gopcnet.pipeline import compose_screen_then_prune, sequential_screen_and_prune_detailed
