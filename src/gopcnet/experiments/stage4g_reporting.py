...
(`gopcnet.experiments.stage4e_reporting._pooled_metrics`) unmodified for
...
def write_stage4g_report(
    ...
    (output_dir / "stage4g_report.md").write_text(
        ...
        "criteria -- a correction found during implementation (`gopcnet.experiments.stage4g_fit`'s "
