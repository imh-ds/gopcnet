...
step (`gopcnet.pipeline.growing_subset_dpi.growing_subset_dpi`) --
...
from gopcnet.pipeline import growing_subset_dpi
...
def run_stage5g(
    ...
    if not write_report:
        return raw
    from gopcnet.experiments.stage5g_reporting import write_stage5g_report
