...
No engine change: `gopcnet.pipeline.sequential_screen_and_prune_detailed`
and `gopcnet.pipeline.compose_screen_then_prune` are both reused
unmodified.
"""
...
from gopcnet.simulation import sample_precision_triangle
