...
`gopcnet.experiments.stage4i_fit` (Stage 4g's own selection rule, with
...
from gopcnet.experiments.stage4i_fit import compute_fitting_points, fitting_point_self_check
