...
unmodified (`gopcnet.experiments.stage2d.Stage2dConfig`,
...
from gopcnet.experiments.stage2d import (
    MOTIF_COMPONENTS,
    OVERLAP_PAIRS,
    Stage2dConfig,
    _condition_seed,
...
def run_stage2h(config: Stage2dConfig, output_dir: Path) -> pd.DataFrame:
    ...
    from gopcnet.experiments.stage2h_reporting import write_stage2h_report
