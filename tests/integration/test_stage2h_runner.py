...
from gopcnet.experiments.stage2d import TRUE_CANDIDATE_PAIRS, load_stage2d_config
from gopcnet.experiments.stage2h import NOISE_COUNT, P, run_stage2h
...
def test_stage2h_provenance_uses_its_own_charter_not_stage2ds(tmp_path: Path, monkeypatch) -> None:
    ...
    gopcnet.experiments.stage2d: evidence must hash docs/stage2h_charter.md,
